...
export default function GoalsPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      <div>
        <h1 className="text-xl font-semibold">Savings goal</h1>
        <p className="text-sm text-muted-foreground">Cash-flow tracking for your current cycle. This is budgeting maths, not investment advice.</p>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p className={`rounded-md border p-3 text-sm ${s.status === "AT_RISK" ? "border-negative/40 bg-negative/10" : "border-border bg-secondary/40"}`}>
                {s.status === "AT_RISK" && "⚠️ Savings goal at risk. "}{s.message}
              </p>
